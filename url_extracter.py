...
async def main():
    ...
    async def handle_request(context: PlaywrightCrawlingContext) -> None:
        ...
        doormat_heading_link_elements=await context.page.query_selector_all('.doormat-heading-link')
        doormat_links_elements=await context.page.query_selector_all('.doormat-links > li')
        crawling_links=[]
